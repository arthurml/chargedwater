...
x_train,x_teste,y_train,y_teste=train_test_split(x_numpy,y_numpy,test_size=0.3,shuffle=True,random_state=43)
...
#y_train_2 = scale_ytg.inverse_transform(y_train)
#x_train_2 = scale_xtg.inverse_transform(x_train)
